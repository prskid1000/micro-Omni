...
def main(cfg):
    ...
    # Check for existing metadata to avoid re-tokenizing if possible (though tokenizer check handles this)
    model_name = "thinker"
    ...
    while epoch < max_epochs:
        ...
        # Let monitor check for loss spike (end-of-epoch validation)
        monitor.on_val_end(avg_val_loss, opt, {"model": model}, logger)
        most_recent_val_loss = avg_val_loss
