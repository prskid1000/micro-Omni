...
**Why this matters:**
- Training saves both final models (`model.pt`) and step checkpoints (`model_step_X.pt`)
- Tests should prefer final models, but fall back to latest step checkpoint
- Ensures tests work even if final checkpoint is missing
